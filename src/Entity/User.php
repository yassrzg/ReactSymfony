...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    public function getRegimeUser(): ?string
    {
        return $this->RegimeUser;
    }

    public function setRegimeUser(?string $RegimeUser): static
    {
        $this->RegimeUser = $RegimeUser;
    ...
    public function getAllergieUser(): ?string
    {
        return $this->AllergieUser;
    }
